...
fun SimpleExoPlayer.preparePlayer2(playerView: PlayerView, forceLandscape:Boolean = false) {
    (playerView.context as AppCompatActivity).apply {
        ...
        fullScreenButton.setOnClickListener {
            ...
            PlayerView.switchTargetView(this@preparePlayer2, playerView, playerViewFullscreen)
        }
        normalScreenButton.setOnClickListener {
            ...
            playerViewFullscreen.visibility = View.GONE
            PlayerView.switchTargetView(this@preparePlayer2, playerViewFullscreen, playerView)
        }
        playerView.resizeMode = AspectRatioFrameLayout.RESIZE_MODE_FIXED_HEIGHT
        playerView.player = this@preparePlayer2
    }
}
fun SimpleExoPlayer.setSource2(context: Context, url: String){
