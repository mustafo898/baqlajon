...
import uz.rounded.baqlajon.presentation.ui.main.my_courses.detail.pager.detail.SectionDetailsFragment
...
class PlayerFragment : BaseFragment<FragmentPlayerBinding>() {
    ...
    private fun setUpResultListener() {
        setFragmentResultListener(SectionDetailsFragment.VIDEO_BUNDLE_KEY) { _, bundle ->
            val videos =
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                    bundle.getParcelableArrayList(
                        SectionDetailsFragment.VIDEO_LIST_BUNDLE_KEY,
                        Video::class.java
                    )
                } else {
                    @Suppress("deprecation")
                    bundle.getParcelableArrayList(SectionDetailsFragment.VIDEO_LIST_BUNDLE_KEY)
                }.orEmpty()
